...
public class RoughDraft implements ActionListener {
    ...
    RoughDraft() {
        ...
        frame.setContentPane(new JLabel(new ImageIcon
                ("C:\\Users\\AlexaD\\Documents\\NetBeansProjects\\RoughDraft\\blue_background.jpg")));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getActionCommand().equals("Load a file...")) {
            ...
            //starts script
			new ProcessBuilder("/home/gui/run.sh compile").start();
			Thread.sleep(1000);
			new ProcessBuilder("/home/gui/run.sh test TestPrograms " + f.getName()).start();
			
            // set text to wait 10 seconds
            sleeper.setText("<html><font color=#CE0000>Please wait 10 seconds...</font></html>");
